var app = angular.module('client2App', ['ngRoute', 'ngCookies']);
        ...
        .when('/', {
            resolve: {
                "check": function ($location, $cookies, $window, $http) {
                    ...
                    var applicationUrl = 'http://localhost:8085/#/';
...
app.controller('client2Controller', function ($scope, $location, $rootScope, $cookies) {
